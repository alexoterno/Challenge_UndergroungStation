...
# size of our images.
img = cv2.imread('/my_data/data_train/14-parilly/14-parilly0.jpg')  # an test image just to get the size
...
def save_bottlebeck_features():
    ...
    datagen = ImageDataGenerator(rescale=1. / 255)  # value 0-255 to 0-1
